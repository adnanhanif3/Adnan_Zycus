...
WebUI.sendKeys(findTestObject('Page_Home/Top Nav/Globalsearch_box'), 'Assign To : Default assigned to group + Editable')
...
WebUI.setText(findTestObject('Page_Create Request/drpdown_AssignTo'), 'Sup')

WebUI.click(findTestObject('Page_Create Request/drpdwn_GrpSuperUser'))
...
WebUI.verifyElementText(findTestObject('Page_View request/txt_AssignToName'), 'Super Users')
