...
String policyTitleText = WebUI.getText(findTestObject('Page_Policy Listing/Policy Title'))

WebUI.click(findTestObject('Page_Policy Listing/Policy Title'))

WebUI.verifyElementText(findTestObject('Page_View Policy Page/Sub Page Title'), policyTitleText)
