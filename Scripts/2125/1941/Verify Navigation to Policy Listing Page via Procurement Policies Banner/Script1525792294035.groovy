...
WebUI.scrollToElement(findTestObject('Page_Home/Procurement policies banner/Explorepolicies_btton'), 1)

WebUI.click(findTestObject('Page_Home/Procurement policies banner/Explorepolicies_btton'))
