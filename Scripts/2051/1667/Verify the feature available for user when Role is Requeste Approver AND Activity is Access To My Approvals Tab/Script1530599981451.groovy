...
WebUI.callTestCase(findTestCase('Common TC/Frank R Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('Page_Home/Top Nav/Globalsearch_box'), 0)

WebUI.verifyElementNotPresent(findTestObject('Page_Home/Procurement Services/Procurement Services Heading'), 0)
