...
WebUI.setText(findTestObject('Page_Login/UserId'), findTestData('Auth Test Data/Application Login').getValue(1, 1))

WebUI.click(findTestObject('Page_Login/GhoshPassword'))

WebUI.setText(findTestObject('Page_Login/Password'), findTestData('Auth Test Data/Application Login').getValue(2, 1))
