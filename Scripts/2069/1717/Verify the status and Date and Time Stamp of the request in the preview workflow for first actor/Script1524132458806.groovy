...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'Test_Status_Timestamp')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing status and timestamp of the requester')
...
String reqNumText = WebUI.getText(findTestObject('Page_Service request/Request_number'))
