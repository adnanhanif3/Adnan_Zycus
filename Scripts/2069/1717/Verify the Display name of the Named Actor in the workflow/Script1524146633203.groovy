...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'Test_NamedActor')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing display name of named actor')
