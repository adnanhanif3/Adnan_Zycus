...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), '外面你好 Բարեւից դուրս')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing Page Title with non english characters')
