...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'It is a long established fact that a reader will be distracted by the readable content of a page whe')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing Page Title with maximum characters')
