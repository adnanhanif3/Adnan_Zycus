...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'Test_PageTitle1234')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing Page Title with alphanumeric characters')
