...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'Test Version creation')
...
WebUI.click(findTestObject('Page_View request/Version DropDown'))

WebUI.click(findTestObject('Page_View request/Version Option'))

WebUI.verifyOptionSelectedByLabel(findTestObject('Page_View request/Version DropDown'), 'Version 1', false, 5)
