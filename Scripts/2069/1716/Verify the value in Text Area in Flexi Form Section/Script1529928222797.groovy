...
WebUI.sendKeys(findTestObject('Page_Edit request/Flexiform_fields/Text_area'), '25/319 Wisconsin Street')
...
WebUI.verifyElementText(findTestObject('Page_View request/FlexiForm/FF Address'), '25/319 Wisconsin Street')
