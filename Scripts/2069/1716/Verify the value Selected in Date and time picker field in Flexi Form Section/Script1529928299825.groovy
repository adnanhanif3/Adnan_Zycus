...
WebUI.selectOptionByValue(findTestObject('Page_Edit request/Flexiform_fields/Year_field'), '2018', false)

WebUI.click(findTestObject('Page_Edit request/Flexiform_fields/Day_selecter'))

WebUI.selectOptionByValue(findTestObject('Page_Edit request/Flexiform_fields/Hour dropdown'), '10', false)

WebUI.selectOptionByValue(findTestObject('Page_Edit request/Flexiform_fields/Minute dropdown'), '25', false)
...
WebUI.verifyElementText(findTestObject('Page_View request/FlexiForm/FF Date Time'), '2018/06/19 10:25')
