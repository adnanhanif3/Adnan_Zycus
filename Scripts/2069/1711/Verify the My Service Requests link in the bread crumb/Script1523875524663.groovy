...
WebUI.sendKeys(findTestObject('Page_Create Request/txt_RequestName'), 'Test_MyServiceRequestNavigation')

WebUI.sendKeys(findTestObject('Page_Create Request/txtarea_Desc'), 'Testing My Service Request in breadcrumb')
