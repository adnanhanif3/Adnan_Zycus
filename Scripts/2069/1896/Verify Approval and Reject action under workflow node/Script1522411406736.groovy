...
WebUI.verifyElementPresent(findTestObject('Page_Approval Listing/Workflow Reject'), 5)

WebUI.verifyElementText(findTestObject('Page_Approval Listing/Workflow Reject'), 'Reject')
