...
WebUI.verifyElementPresent(findTestObject('Page_Edit request/Flexiform_fields/Element_table'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Page_Approval Listing/Alert_close'), FailureHandling.STOP_ON_FAILURE)
