...
WebUI.click(findTestObject('Page_Service request/Cancel-Delete'))

WebUI.verifyElementPresent(findTestObject('Page_Service request/Edit request button(Draft)'), 0)
