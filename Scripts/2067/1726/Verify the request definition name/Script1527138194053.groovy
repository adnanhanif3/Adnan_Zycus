...
text = WebUI.getText(findTestObject('Page_Create Request/txt_PageTitle'))
...
WebUI.verifyElementText(findTestObject('Page_Approval Listing/Card_requestdefinition'), text)
