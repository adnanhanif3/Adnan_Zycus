...
text = WebUI.getText(findTestObject('Page_Service request/field_updatedondate'))
...
WebUI.verifyElementText(findTestObject('Page_Approval Listing/Card_updatedondate'), text)
