...
text = WebUI.getText(findTestObject('Page_Create Request/Field_requesttype'))
...
WebUI.verifyElementText(findTestObject('Page_Approval Listing/Card_requesttype'), text)
