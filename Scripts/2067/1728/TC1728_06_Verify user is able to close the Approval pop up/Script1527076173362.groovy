...
WebUI.verifyElementPresent(findTestObject('Page_Service request/btn_Close popup Approve'), 20)

WebUI.click(findTestObject('Page_Service request/btn_Close popup Approve'))
