...
WebUI.click(findTestObject('Procurement member listing page/Bredcmb_home'))

WebUI.verifyElementPresent(findTestObject('Procurement member listing page/Btn_viewall'), 0)
